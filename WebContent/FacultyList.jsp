...
%>
		...
		<fieldset>
			...
			<div
				...
				<p>
					search faculty : <input name="applicantName" id="applicantName"
						type="text" placeholder="search name"
						onkeyup="showHint(this.value,'faculty')"> <select
						id="txtHint">
						<option>search result</option>
					</select>
					<button onclick="" type="button">open</button>
				</p>

				<h4 align="right">
					<a href="AddNewFaculty.jsp?userid=<%=userid %>">Add a new
						Faculty</a>
				</h4>
				...
				<form action="confirmAdmission" method="post">
					<input type="hidden" name="position" value="faculty">
					...
					<table align="center" border="1" width="100%">
						...
						<% 
ResultSet rs=UserGuiDB.getAnyListFromDB(connection,"position", "faculty");
